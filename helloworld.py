...
import time, random, wikipedia, sys, json, codecs, threading, glob, re, string, os, requests, six, ast, pytz, urllib, urllib3, urllib.parse, traceback, atexit
listApp = [
...
client = LINE()
#client = LINE("EwkXt3Ag7ltc5gthMJV2.gVr/dGkQP7TQft62cVhgmG.Bp8aFN16ZN4LMYkMpfY09/fabVseljIjm3eb4Rh62Ns=")
...
#####===============[TIKEL]===============#####
                                                                   ...
                                                                   "contents": {
                                                                       ...
                                                                       "body": {
                                                                               ...
                                                                               "contents": [
                                                                                  ...
                                                                                  {
                                                                                    "type": "text",
                                                                                    "text": contact.displayName+" profile",
                                                                                    "wrap": True
                                                                                  }
                                                                               ]
                                                                       },
                                                                               ...
                                                                               "contents": [
                                                                                  ...
                                                                                  },
                                                                                  {
                                                                                    ...
                                                                                    "action": {
                                                                                        "type": "uri",
                                                                                        "label": "Creator",
                                                                                        "uri": "https://line.me/ti/p/~denmas_geo"
                                                                                     }
                                                                                  }
                                                                               ]
                                                                       }
						...
						if cmd == "me":
							...
							client.sendMessage(to, a.displayName, client.musiknad("http://dl.profile.line-cdn.net/"+ a.picturePath, a.displayName if a.displayName != '' else a.userid, a.statusMessage if a.statusMessage != '' else 'line://ti/p/~denmas_geo'),19)
#######==============#######
						if cmd == "logout":
