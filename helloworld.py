...
###=====[Template]======######
						...
						if cmd.startswith("yes"):
							url = "https://3.bp.blogspot.com/-d6ca5ZMr0c4/WUMi61CnaWI/AAAAAAAPwZ0/OvlHL1BSJQ83WEzz4HsHAfOSuvRVVXakQCLcBGAs/s1600/AW448914_00.gif"
							data = {
								"type": "template",
								"altText": "Sticker",
								"template": {
							...
							client.postJungelpang(to, data)
						if cmd.startswith("hahaha"):
							url = "https://1.bp.blogspot.com/-D9cUc7cSwo8/WymQcjyripI/AAAAAAAgalg/JPLSBFWate0ybQNS2M5SEL9xdplhrxXrgCLcBGAs/s1600/AW1238395_00.gif"
							data = {
								"type": "template",
								"altText": "Sticker",
								"template": {
							...
							client.postJungelpang(to, data)
						if cmd.startswith("hadeh"):
							url = "https://1.bp.blogspot.com/-nTDnVZAHnrQ/WUMi7D85vfI/AAAAAAAPwZ4/MSwo7aeNGQIrxrYdfHpEhTZcYx5aSWRDACLcBGAs/s1600/AW448914_01.gif"
							data = {
								"type": "template",
								"altText": "Sticker",
								"template": {
							...
							client.postJungelpang(to, data)
						if cmd.startswith("hemm"):
							url = "https://1.bp.blogspot.com/-zZ-GYVl_-Lw/W28mVX0v1-I/AAAAAAAX7Qg/a0KPNKGSGZ0IAaLee-gLi9S2dPKUmw_nACLcBGAs/s1600/AW1527989_01.gif"
							data = {
								"type": "template",
								"altText": "Sticker",
								"template": {
										...
										"contents": {
											...
											"body": {
												...
												"contents": [
													...
													{
														"type": "text",
														"text": "╠ Terimkasih Kepada"
													},
													{
														"type": "text",
														"text": "╠ HelloWorld and Friend"
													},
													{
														"type": "text",
														"text": "╚══════════"
...
#######==============#######
						if cmd == "logout":
							...
							try:
								ret_ = "╔══[ Status ]══"
								ret_ +="\n╠ Auto Add Message :\n╠ {}".format(settings["autoAddMessage"])
								ret_ +="\n╠ Auto Join Message :\n╠ {}".format(settings["autoJoinMessage"])
								ret_ +="\n╠ Auto Respon Message :\n╠ {}".format(settings["autoResponMessage"])
								ret_ += "\n╚══[ Status ]══"
								client.sendMessage(to, str(ret_))
							except Exception as error:
								logError(error)
